...
from utils.constants import google_api_key, ATTACK_RM_PATH, SUPPORT_RM_PATH
...
def HelperClient(prompt, model="meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo", temperature=0.7, max_tokens=1000, n=1, stop=None, sys=None) -> list:
    if sys is not None:
